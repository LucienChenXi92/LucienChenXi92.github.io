...
> 最近在知乎上看到两篇关于Java内存模型的文章，讲的非常透彻，而且纠正了很多以前的理解误区，分享一下：
> 第一篇： [《什么是Java内存模型》 – 占小狼](https://www.jianshu.com/p/bf158fbb2432)
> 第二篇： [《深入理解JVM-内存模型（jmm）和GC》 – Garwer](https://www.jianshu.com/p/76959115d486)
